...
import arefin.dialogs.util.SparseBooleanArrayParcelable;

/**
 * Dialog with a list of options.
 * <p/>
 * Implement {@link arefin.dialogs.iface.IListDialogListener} to handle selection of single and no choice
 * modes. Implement {@link arefin.dialogs.iface.IMultiChoiceListDialogListener} to handle selection of
 * multi choice.
 */
